...
1. A counter, which shows your sparks (being on the left a 3d spark floating → [assets/icons/3d-spark.png](../../../../assets/icons/3d-spark.png) *(missing)*) and on the right, the actual counter -- on this section, the background is a gradient from top left to bottom right of the section container, from pink to neon pink. The 3d spark (and other sparks) contrast in color.
