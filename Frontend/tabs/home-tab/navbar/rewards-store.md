...
1. A counter, which shows your sparks (being on the left a 3d spark floating → [assets/3d-spark/3d-spark.glb](../../../../assets/3d-spark/3d-spark.glb)) and on the right, the actual counter -- on this section, the background is a gradient from top left to bottom right of the section container, from pink (`FFC0CB`) to neon pink (`FF10F0`). The 3d spark (and other sparks) contrast in color.
