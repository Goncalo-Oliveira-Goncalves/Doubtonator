...
> **Suggested edit (Streak Popup):** The `<!-- steal calendar thing -->` comment is a TODO — replace with a real reference once a Duolingo-inspired streak calendar prototype is built.
