...
Then, second element is the streak, this element is very important, it guarantees gamification, there are a few things to take note, first, the icon, if the streak is none, either because they lost it or they are new... then it will be a grey svg of a fire → [assets/icons/streak-fire-grey.svg](../../../assets/icons/streak-fire-grey.svg) *(missing)*. Then, if they do have a streak, we will give them 5 variations. Yellow, Yellow-Orange, Orange, Orange-Blue, Blue (please reference to the "Database Structure Backend.md" for more information)

If they keep the streak for long enough, fire will evolve in the ways states previously...

Being:
- Yellow (achieved 1st week) → [assets/icons/streak-fire-yellow.svg](../../../assets/icons/streak-fire-yellow.svg) *(missing)*
- Yellow-Orange (achieved 1st month) → [assets/icons/streak-fire-yellow-orange.svg](../../../assets/icons/streak-fire-yellow-orange.svg) *(missing)*
- Orange (achieved 3rd month) → [assets/icons/streak-fire-orange.svg](../../../assets/icons/streak-fire-orange.svg) *(missing)*
- Orange-Blue (achieved 7th month) → [assets/icons/streak-fire-orange-blue.svg](../../../assets/icons/streak-fire-orange-blue.svg) *(missing — gradient SVG)*
- Blue (achieved 1 year) → [assets/icons/streak-fire-blue.svg](../../../assets/icons/streak-fire-blue.svg) *(missing)*
...
The icon will have the image of some sparkles → [assets/icons/sparks-icon.svg](../../../assets/icons/sparks-icon.svg) *(missing)*. Contrary to streaks, doesn't change, and upon clicking the sparks, you get to the _rewards store_, which we'll get to in a bit.
