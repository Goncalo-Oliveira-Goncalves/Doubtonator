...
Section 2 is basically a timeline view which has a filter for the events on that day, this filter is applied on the backend of course, and it'0s not a UI interactive element.