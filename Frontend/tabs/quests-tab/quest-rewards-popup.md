...
The reward on the other hand is 3 elements, an animation of a spark → [assets/animations/spark-burst.lottie](../../../assets/animations/spark-burst.lottie) *(deferred to version omega)*, and then, below that, a counter, and below that, a text saying "Sparks", the counter shows the number of sparks they got from the quest.
