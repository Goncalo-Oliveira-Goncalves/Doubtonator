...
If you slowly swipe left, you will see an arrow on the left pointing to the left with the text "disapprove" in a red container. (with a little shadow over everything else)
...
> **Suggested edit (Approve Scripts):** The in-progress indicator text on the swipe overlay — "disapprove" and "approve" — should match the heading names used in the quest board ("Approve Scripts"). Confirm: is "disapprove" the correct term, or should it be "reject"?
